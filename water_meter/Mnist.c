...
//#include "Mnist_trained_coef_n15000.def"
#include "ImgIO.h"
...

{
	...
	for(int digit=0;digit<COUNTER_DIGITS;digit++){
		...
		Conv5x5ReLUMaxPool2x2_0((short int*)ImageIn   , L2_W_0, Out_Layer0, 12, L2_B_0, 0);
		//DumpPaddedCoeff("OUTPUT Layer 1",Out_Layer0,12*12,32);
		Conv5x5ReLUMaxPool2x2_1(            Out_Layer0, L2_W_1, Out_Layer1, 12, L2_B_1, 0);
		//DumpPaddedCoeff("OUTPUT Layer 1",Out_Layer1,4*4,32);
		LinearLayerReLU_2      (            Out_Layer1, L2_W_2, 14, L2_B_2, 10, Out_Layer2, 10, 0);
