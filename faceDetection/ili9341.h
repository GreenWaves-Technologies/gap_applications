...
void drawChar(rt_spim_t *spim,int16_t x, int16_t y, unsigned char c, uint16_t color, uint16_t bg, uint8_t size);
...
void drawRGBBitmap(rt_spim_t *spim,signed short x, signed short y,  unsigned short *pcolors, signed short w, signed short h) ;
