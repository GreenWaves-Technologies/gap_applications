...
void async_cascade_stage_to_l1(single_cascade_t* cascade_l2, single_cascade_t* cascade_l1, rt_dma_copy_t* Dma_Evt){
    ...
    addr+=sizeof(short)*cascade_l1->stage_size;
    rt_dma_memcpy((unsigned int) cascade_l2->alpha1, (unsigned int) cascade_l1->alpha1, sizeof(short)*cascade_l1->stage_size, RT_DMA_DIR_EXT2LOC, 1, Dma_Evt);
    //rt_dma_wait(Dma_Evt);

    cascade_l1->alpha2         = (short*) addr;//rt_alloc( RT_ALLOC_CL_DATA, sizeof(short)*cascade_l2->stage_size);
    addr+=sizeof(short)*cascade_l1->stage_size;
    rt_dma_memcpy((unsigned int) cascade_l2->alpha2, (unsigned int) cascade_l1->alpha2, sizeof(short)*cascade_l1->stage_size, RT_DMA_DIR_EXT2LOC, 1, Dma_Evt);
    //rt_dma_wait(Dma_Evt);
    ...
    rt_dma_memcpy((unsigned int) cascade_l2->rect_num, (unsigned int) cascade_l1->rect_num, sizeof(unsigned short)*(cascade_l1->stage_size+1), RT_DMA_DIR_EXT2LOC, 1, Dma_Evt);
    //rt_dma_wait(Dma_Evt);
    ...
    rt_dma_memcpy((unsigned int) cascade_l2->weights, (unsigned int) cascade_l1->weights, sizeof(signed char)*(cascade_l2->rectangles_size/4), RT_DMA_DIR_EXT2LOC, 1, Dma_Evt);
    //rt_dma_wait(Dma_Evt);
    ...
    rt_dma_memcpy((unsigned int) cascade_l2->rectangles, (unsigned int) cascade_l1->rectangles, sizeof(char)*cascade_l2->rectangles_size, RT_DMA_DIR_EXT2LOC, 1, Dma_Evt);
    rt_dma_wait(Dma_Evt);
